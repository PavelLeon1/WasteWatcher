...
def build_filter_pipeline(
    ...
    Args:
        ...
        root_path: Абсолютный путь корневой директории сканирования (для max_depth_filter).
...
if __name__ == "__main__":
    ...
    # Тест max_depth_filter с root_path
    depth_filter = max_depth_filter(2, "/")
    # Файл /small.log имеет глубину 1 (relative_to("/") → 'small.log' → 1-1=0)
    assert depth_filter(test_files[0]) is True
